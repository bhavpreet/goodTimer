...
require (
	github.com/bhavpreet/goodTimer/devices/timy2/usb v0.0.0-20220830100408-63c481caf165
...
require (
	...
	github.com/bhavpreet/goodTimer/devices/timy2 v0.0.0-20220830100408-63c481caf165 // indirect
